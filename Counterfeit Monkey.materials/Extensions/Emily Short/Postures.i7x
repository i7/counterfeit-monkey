...
Does the player mean sitting on an enterable thing when the posture of the noun is seated (this is the prefer sitting on seating objects rule):
	it is very likely.

Does the player mean standing up on an enterable thing when the posture of the noun is standing (this is the prefer standing on standing objects rule):
	it is very likely.

Does the player mean lying on an enterable thing when the posture of the noun is reclining (this is the prefer lying on reclining objects rule):
	it is very likely.

Does the player mean asking someone to try sitting on an enterable thing when the posture of the noun is seated (this is the prefer request sitting on seating objects rule):
	it is very likely.

Does the player mean asking someone to try standing up on an enterable thing when the posture of the noun is standing (this is the prefer request standing on standing objects rule):
	it is very likely.

Does the player mean asking someone to try lying on an enterable thing when the posture of the noun is reclining (this is the prefer request lying on reclining objects rule):
	it is very likely.
...
Check an actor exiting when the holder of the actor is a room (this is the convert exits to standing rule):
	if the posture of the actor is not standing:
		try the actor taking position standing instead.

Section 10 - Jump only when standing
